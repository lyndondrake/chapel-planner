	...
	<form method="POST" class="max-w-2xl space-y-6">
		<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
			...
			<div>
				...
				<input type="date" id="date" name="date" required class="input w-full rounded border border-surface-600 bg-surface-800 px-3 py-2" />
			</div>
			<div>
				<label for="time" class="mb-1 block text-sm font-medium">Start Time</label>
				<input type="time" id="time" name="time" class="input w-full rounded border border-surface-600 bg-surface-800 px-3 py-2" />
			</div>
			<div>
				<label for="endTime" class="mb-1 block text-sm font-medium">End Time</label>
				<input type="time" id="endTime" name="endTime" class="input w-full rounded border border-surface-600 bg-surface-800 px-3 py-2" />
			</div>
		</div>

		<div>
			<label for="title" class="mb-1 block text-sm font-medium">Title</label>
			<input type="text" id="title" name="title" class="input w-full rounded border border-surface-600 bg-surface-800 px-3 py-2" placeholder="Optional display title" />
		</div>
		...
		<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
			...
			<div>
				...
				<input type="text" id="location" name="location" value="Chapel" class="input w-full rounded border border-surface-600 bg-surface-800 px-3 py-2" />
			</div>
		</div>
		...
		<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
			<div>
				...
				<input type="text" id="liturgicalDay" name="liturgicalDay" class="input w-full rounded border border-surface-600 bg-surface-800 px-3 py-2" placeholder="e.g. Third Sunday of Advent" />
			</div>
			<div>
